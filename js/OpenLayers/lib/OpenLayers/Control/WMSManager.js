  ...
  // DOM Elements
    ...
    */  
						...
						for(y=0;y<layer.aWMSLayers.length;y++){
							...
							if(selectedLayer==listedLayer[0]) {
								...
								if(SLDManager && sldService){
									...
									console.log('service 3:' + this.sldService);
    ...
    loadContents: function() {
		...
		this.olCatalogue.style.height = this.map.size.h - 130;
		...
		this.olServerList.style.height = this.map.size.h - 130;
        ...
        */
		...
		this.olLegend.style.height = this.map.size.h - 130;
    ...
    addCatalogueLayer: function() {
        var select = this.WMSManager.catalogueSelect;
		console.log(select);
		...
		console.log(layer);
		 ...
		 this.WMSManager.aWMSLayers.push([Name,Title,Abstract,BoundingBox,HREF,queryable]);
		 var aWMSLayers = this.WMSManager.aWMSLayers;
